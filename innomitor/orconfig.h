...
/* Defined if we try to collect buffer statistics */
/* #undef ENABLE_BUFFER_STATS */
...
/* #undef ENABLE_DIRREQ_STATS */

/* Defined if we try to collect per-country statistics */
/* #undef ENABLE_ENTRY_STATS */

/* Defined if we try to collect per-port statistics on exits */
/* #undef ENABLE_EXIT_STATS */
...
/* #undef HAVE_EVENT_GET_VERSION_NUMBER */
...
#define VERSION "0.2.2.0-alpha-dev_for_BitBlinder_0.5.0"
