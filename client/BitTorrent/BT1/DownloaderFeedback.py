...
class DownloaderFeedback:
    ...
    def spews(self):
        ...
        for c in cs:
            ...
            #Jash added:
            a['pendingRequests'] = len(c.download.active_requests)
            try:
              a['circId'] = c.protocol.transport.nomnetStream.circuit.id
            except:
              a['circId'] = -1
            
            a['id'] = c.get_readable_id()
            a['client'] = c.get_client_name()
            a['ip'] = c.get_ip()
            ...
            a['completed'] = d.get_peer_completion()
